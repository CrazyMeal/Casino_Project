...
public class BruteWriter {
	private OutputStream outputStream;
	private ByteArrayOutputStream byteOutputStream;
	
	public BruteWriter(){}
	
	public BruteWriter(OutputStream outputStream){
		this.outputStream = outputStream;
		this.byteOutputStream = new ByteArrayOutputStream();
	}
	public void writeBrute(Brute brute){
		this.writeString(brute.getName());
		this.writeInt(brute.getLevel());
		this.writeInt(brute.getLife());
		this.writeInt(brute.getStrength());
		this.writeInt(brute.getSpeed());
	}
